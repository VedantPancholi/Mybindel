...
class _AlphabeticScrollViewState extends State<AlphabeticScrollView> {
  ...
  void initState() {
    int i = 0;
    this.items_list = widget.items
        .map((item) => ArtistList( id: i++,title: item, tag: item[0].toUpperCase()))
        .toList();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AzListView(
      ...
      indexBarOptions: IndexBarOptions(
        ...
        selectItemDecoration: provider.currentTheme
            ? square_neu_Morphism
            : square_dark_neu_Morphism,
        decoration: provider.currentTheme
            ? BoxDecoration(
  ...
  Widget _buildListItem(ArtistList item) {
    ...
    return Container(
        ...
        margin: EdgeInsets.only(
            right: 12.w, bottom: 1.2.h, top: 0.5.h, left: 1.4.w),
