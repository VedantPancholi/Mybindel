...
class BlockFriends extends StatefulWidget {
  ...
  BlockFriends({super.key});

  @override
  State<BlockFriends> createState() => BlockFriendsState();
}

class BlockFriendsState extends State<BlockFriends> {
  ...
  Widget build(BuildContext context) {
    ...
    final friends = friendObject.getblockedfriends;

    return friends.length > 0 ? ListView.builder(
      physics: const BouncingScrollPhysics(),
      itemCount: friends.length,
      itemBuilder: (context, blockedfriendIndex) {
        return Slidable(
          startActionPane: ActionPane(
              ...
              children: [
                SlidableAction(
                  onPressed: (val) {
                    friendObject.removefromBlockList(blockedfriendIndex);
                    setState(() {});
                  },
                        ...
                        child: Container(
                          ...
                          child: Stack(children: [
                            ClipRRect(
                              ...
                              child: Image.asset(
                                friends[blockedfriendIndex].picture,
                                fit: BoxFit.cover,
                              ),
                            ),
                            Positioned(
                        ...
                        children: [
                          RichText(
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text: friends[blockedfriendIndex].name,
                                  style: TextStyle(
                                      fontSize: 20,
                                      letterSpacing: 1.2,
                          ...
                          AutoSizeText(
                            friends[blockedfriendIndex].occupation.toUpperCase(),
                            style: TextStyle(
                                color: orange_color,
                                fontWeight: FontWeight.w500,
                                fontSize: 13),
    ...
    ):Center(child: Text('No Blocked Friends'),);
  }
}