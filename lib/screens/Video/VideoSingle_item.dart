    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            // height: 45.h,
            height: _controller.value.size.height / 2 < (33.0).h ? (33.0).h : _controller.value.size.height - 50,
            // color: Colors.red,
            ...
            child: Row(
              children: [
                ...
                Container(
                  height: _controller.value.size.height < (33.0).h ? (33.0).h : _controller.value.size.height - 50,
                  width: (13.00).w,
                  // color: Colors.amber,
